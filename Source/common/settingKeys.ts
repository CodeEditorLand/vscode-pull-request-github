...
export const PULL_PR_BRANCH_BEFORE_CHECKOUT =
	"pullPullRequestBranchBeforeCheckout";
export type PullPRBranchVariants =
	| "never"
	| "pull"
	| "pullAndMergeBase"
	| "pullAndUpdateBase"
...
export const EXPERIMENTAL_NOTIFICATIONS_PAGE_SIZE =
	"experimental.notificationsViewPageSize";
export const EXPERIMENTAL_NOTIFICATIONS_SCORE =
	"experimental.notificationsScore";
