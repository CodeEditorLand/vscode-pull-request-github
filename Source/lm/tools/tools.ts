...
function registerFetchingTools(
	context: vscode.ExtensionContext,
	credentialStore: CredentialStore,
	repositoriesManager: RepositoriesManager,
	chatParticipantState: ChatParticipantState,
...
function registerSummarizationTools(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		vscode.lm.registerTool(
			...
			new NotificationSummarizationTool(),
		),
	);
}

function registerSuggestFixTool(
	context: vscode.ExtensionContext,
	credentialStore: CredentialStore,
	repositoriesManager: RepositoriesManager,
	chatParticipantState: ChatParticipantState,
...
function registerSearchTools(
	...
	context.subscriptions.push(
		vscode.lm.registerTool(
			ConvertToSearchSyntaxTool.toolId,
			new ConvertToSearchSyntaxTool(
				credentialStore,
				repositoriesManager,
				chatParticipantState,
			),
	...
	context.subscriptions.push(
		vscode.lm.registerTool(
			...
			new DisplayIssuesTool(chatParticipantState),
		),
	);
}
